...
l1 = b1.lists.create(title: 'todo', ord: 1.0)
l2 = b1.lists.create(title: 'doing', ord: 3.0)
l3 = b1.lists.create(title: 'done', ord: 2.0)

c1 = l3.cards.create(title: 'squats', description: 'feel the burn', ord: 3.0)
c2 = l3.cards.create(title: 'pushups', description: 'ooh ouch', ord: 2.0)
c3 = l3.cards.create(title: 'situps', description: 'ouchy', ord: 1.0)

c4 = l1.cards.create(title: 'squats', description: 'feel the burn', ord: 1.0)
c5 = l1.cards.create(title: 'pushups', description: 'ooh ouch', ord: 3.0)
c6 = l1.cards.create(title: 'situps', description: 'ouchy', ord: 2.0)
